...
//Là 1 lớp con của FlowLayout trong Java Swing được thiết kế để hỗ trợ việc xếp các thành phần
//(components) trong GUI và hỗ trợ xuống dòng khi không đủ không gian để đặt tất cả 
//thành phần trong 1 dòng duy nhất
