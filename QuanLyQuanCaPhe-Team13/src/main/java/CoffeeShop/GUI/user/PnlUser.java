...
public class PnlUser extends javax.swing.JPanel implements JDModifyUser.CallbackUserModify, JDDeleteUser.CallbackUserDelete, JDSearchUser.CallbackUserSearch {
    ...
    public void loading(User newUser) {
        ...
        String columns[] = {"ID", "Tên", "Email", "Quyền"};
        DefaultTableModel dtm = new DefaultTableModel(columns, 0);

        if (!Common.isNullOrEmpty(users)) {
            users.forEach(obj -> {
                dtm.addRow(new Object[]{obj.getId(), obj.getName(), obj.getEmail(), obj.getRole() == 1 ? "Admin" : "Nhân viên"});
            });
    ...
    private void lblAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAddMouseClicked
        JDModifyUser jdm = new JDModifyUser(parent, true, dbUtil, this, null, 0);
        jdm.setVisible(true);
    ...
    private void lblUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUpdateMouseClicked
        if (!Common.isNullOrEmpty(user)) {
            if (Objects.equals(currentUser.getId(), user.getId())) {
                JDModifyUser jdm = new JDModifyUser(parent, true, dbUtil, this, user, 1);
                jdm.setVisible(true);
            }
            else {
                JDModifyUser jdm = new JDModifyUser(parent, true, dbUtil, this, user, 0);
                jdm.setVisible(true);
            }
        }
