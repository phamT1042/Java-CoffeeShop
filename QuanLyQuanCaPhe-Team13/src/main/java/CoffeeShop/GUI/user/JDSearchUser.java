...
public class JDSearchUser extends javax.swing.JDialog {

    private User user;
    private CallbackUserSearch callback;
    ...
    public JDSearchUser(java.awt.Frame parent, boolean modal, CallbackUserSearch callback) {
        ...
        String pers[] = {"Không chọn", "Admin", "Nhân viên"};
        for (String per : pers) 
            dcbm.addElement(per);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (validate) {
            ...
            if (!"Không chọn".equals(cboPermission.getSelectedItem().toString())) 
                user.setRole("Admin".equals(cboPermission.getSelectedItem().toString()) ? 1 : 0);          
