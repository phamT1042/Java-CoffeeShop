...
public final class JDSearchProduct extends javax.swing.JDialog {
    ...
    private void btnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyActionPerformed
        product = new Product();
        Integer fromPrice = "".equals(txtFromPrice.getText()) ? null : Integer.valueOf(txtFromPrice.getText());
        Integer toPrice = "".equals(txtToPrice.getText()) ? null : Integer.valueOf(txtToPrice.getText());
