...
public class JDDeleteTable extends javax.swing.JDialog {
    ...
    public JDDeleteTable(java.awt.Frame parent, boolean modal, DbUtil dbUtil, CallbackTableDelete callback, Table table) {
        super(parent, modal);
        initComponents();
        ...
        lblConfirm.setText(lblConfirm.getText() + table.getName());
    ...
    private void initComponents() {
        ...
        lblConfirm.setText("Bạn có chắc chắn muốn xoá bàn tên: ");
